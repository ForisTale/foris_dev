...
from the_elder_commands.inventory import PLUGIN_TEST_FILE, PLUGINS_ERROR_NAME_IS_EMTPY, PLUGINS_ERROR_NAME_BECOME_EMPTY, \
    PLUGIN_TEST_DICT, ADD_PLUGIN_ERROR_FILE
